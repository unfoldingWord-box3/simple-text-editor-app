...
2. a `+`, `-` or a specific character designation in location of the + in the example above, where:<br />
    `+` indicates that a designator should be generated automatically,<br />
    `–` indicates that no designator should be generated, and is not used,<br />
...
| Left-to-Right | Right-to-Left |
| --- | --- |
| `\v 1 The one who expresses God’s character has always existed. He has always existed with God, and he has God’s nature.\f + \fr 1:1 This is a footnote.\f*` | <div dir="rtl">`\v 1 فِي ٱلْبَدْءِ كَانَ ٱلْكَلِمَةُ، وَٱلْكَلِمَةُ كَانَ عِنْدَ ٱللهِ، وَكَانَ ٱلْكَلِمَةُ ٱللهَ.\f + \fr 1:1 هذه حاشية.\f* `</div> |
...
| Left-to-Right | Right-to-Left |
| --- | --- |
| `\v 1 The one who expresses God’s character has always existed. He has always existed with God, and he has God’s nature.\fe + \fr 1:1 This is an endnote.\fe*` | <div dir="rtl">`\v 1 فِي ٱلْبَدْءِ كَانَ ٱلْكَلِمَةُ، وَٱلْكَلِمَةُ كَانَ عِنْدَ ٱللهِ، وَكَانَ ٱلْكَلِمَةُ ٱللهَ.\fe + \fr 1:1 هذه تعليق ختامي\fe* `</div> |
